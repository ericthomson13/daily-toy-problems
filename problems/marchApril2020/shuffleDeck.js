...
var shuffleDeck = function(deck) {
	// create swap helper function so can do in place
	...
	// loop through deck using randomizer and swap on each item
	for (let i = 0; i < deck.length; i++) {
		// use random on length variable to get position for card
